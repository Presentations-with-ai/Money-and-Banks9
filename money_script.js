...
const PREMIUM_STICKER_STATUS_KEY = `quizPremiumSticker_${QUIZ_STORAGE_NAMESPACE}_v2_aprilfools`;
...
function getThemeLabel(fileName) {
  const map = {
    ...
    'dengi_i_banki_tests_part_6.json': 'Вопросы 251-295',
...
<div class="card">
    ...
    <div class="mode-switch" id="test-mode-switch">
        <button type="button" class="mode-switch-btn active" data-mode="regular">Обычный</button>
        <button type="button" class="mode-switch-btn" data-mode="speed">На скорость</button>
        <button type="button" class="mode-switch-btn" data-mode="untimed">Без времени</button>
    </div>
    ...
    <div class="row">
        <select id="theme-select">
            ...
            <option value="dengi_i_banki_tests_part_6.json">Вопросы 251-295</option>
...
function showQuestion() {
  ...
  qContainer.innerHTML = `
    ...
    ${q.examVerifiedOptions === true ? '<div class="generated-options-badge generated-options-badge-test generated-options-badge-verified">Правильный ответ совпадает с итоговым контролем</div>' : ((q.chatgptGeneratedOptions === true && !(Number.isInteger(q?.sourceQuestionNumber) && q.sourceQuestionNumber >= 282 && q.sourceQuestionNumber <= 291)) ? '<div class="generated-options-badge generated-options-badge-test">Варианты сгенерированы с помощью ChatGPT</div>' : '')}
  `;
