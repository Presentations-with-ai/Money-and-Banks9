...
function getThemeLabel(fileName) {
  const map = {
    ...
    'iqtisodiy_siyosat_tests_part_6.json': 'Вопросы 251-300',
    'iqtisodiy_siyosat_tests_part_7.json': 'Вопросы 301-323',
  ...
  container.innerHTML = visibleItems.map((entry) => {
    ...
    return `
      <div class="study-card">
        ...
        <div class="generated-options-badge generated-options-badge-study">Правильные ответы — по официальному источнику</div>
...
<div class="card">
    ...
    <div class="row">
        <select id="theme-select">
            ...
            <option value="iqtisodiy_siyosat_tests_part_6.json">Вопросы 251-300</option>
            <option value="iqtisodiy_siyosat_tests_part_7.json">Вопросы 301-323</option>
...
function showQuestion() {
  ...
  qContainer.innerHTML = `
    ...
    <div class="generated-options-badge generated-options-badge-test">Правильные ответы — по официальному источнику</div>
